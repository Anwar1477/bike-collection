...
const TopFooter = () => {
  return (
    <TopFooterStyled className="container-fluid">
      <div className="top">
        <div className="row">
          <div className="col-md-4 col-lg-4 col-sm-12 col-xs-12">
            <h3 className="my-4">BikersHub</h3>
            <p className="my-4">
              House: 19, Road: 19, Sector: 12, Uttara Model Town, Dhaka 1230,
              Bangladesh
            </p>
            <p className="my-2">Email: anwarhosen.dev@gmail.com</p>
          ...
          <div className="col-md-4 col-lg-4 col-sm-12 Subscribe">
